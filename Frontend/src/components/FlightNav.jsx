    ...
    <nav className="bg-gradient-to-r from-sky-700 to-indigo-900 text-white shadow-lg">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex space-x-6 text-sm font-medium">
          <Link to="/" className="hover:text-amber-300 transition">Dashboard</Link>
          <Link to="/flight-booking" className="hover:text-amber-300 transition">Bookings</Link>
          <Link to="/flights" className="hover:text-amber-300 transition">Flights</Link>
          <Link to="/add-flight" className="hover:text-amber-300 transition">Add Flight</Link>
